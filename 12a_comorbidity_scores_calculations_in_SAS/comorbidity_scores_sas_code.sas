...
/* Read in data (CSV) */
proc import datafile="/mnt/labshares/sanghavi-lab/Jessy/data/trauma_center_project_all_hos_claims/comorbidity_score/2019_for_sas.csv"
...
proc export 
  ...
  dbms=xlsx 
  outfile="/mnt/labshares/sanghavi-lab/Jessy/data/trauma_center_project_all_hos_claims/comorbidity_score/files_output_from_sas/2019_sas_output.xlsx"
  replace;
run;
