...
# The carrier and OP files are too large. I created subsets if the carrier/op contained only bene_id's from my main analytical sample
...
for y in years:
    ...
    rel_bene_carr.to_parquet(f'/mnt/labshares/sanghavi-lab/Jessy/data/trauma_center_project/carr_subset/{y}/',engine='fastparquet',compression='gzip')
...
for y in years:
    ...
    # Read in OP claims
    op = dd.read_parquet(f'/mnt/labshares/sanghavi-lab/Jessy/data/trauma_center_project/op_subset_comorbid/{y}',
                         engine='fastparquet', columns=columns_op)
    ...
    # Read in data
    df_BCARRB = dd.read_parquet(f'/mnt/labshares/sanghavi-lab/Jessy/data/trauma_center_project/carr_subset/{y}/',
    ...
    # Export all raw dx information. Will be used in another code to calculate the comorbidity scores.
    ip_op_carr.to_parquet(f'/mnt/labshares/sanghavi-lab/Jessy/data/trauma_center_project_all_hos_claims/raw_dx_for_comorbidity/{y}/',engine='fastparquet',compression='gzip')
