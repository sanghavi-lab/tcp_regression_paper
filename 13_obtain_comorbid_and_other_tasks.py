...
for y in years:
    ...
    # Read in data from SAS containing comorbidity scores (in pscore code, I needed to separate but now 2016/2017 should be gemmin)
    ...
    claim_w_comorbidity['DT_2_DAYS'] = claim_w_comorbidity['SRVC_END_DT'] + pd.DateOffset(days=2) # used end date because some may have died right after discharge (at hospice for example)
    ...
    claim_w_comorbidity['discharge_death_ind'] = np.where(
                                                       ...
                                                       (claim_w_comorbidity['BENE_DEATH_DT']<=claim_w_comorbidity['DT_2_DAYS']) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT_FOLLOWING_YEAR']<=claim_w_comorbidity['DT_2_DAYS']),
                                                       1,0)
    claim_w_comorbidity['thirty_day_death_ind'] = np.where(
                                                       (claim_w_comorbidity['DSCHRG_CD'].isin(['B','20'])) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT']<=claim_w_comorbidity['DT_1_MONTH']) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT_FOLLOWING_YEAR']<=claim_w_comorbidity['DT_1_MONTH']),
                                                       1,0)
    claim_w_comorbidity['ninety_day_death_ind'] = np.where(
                                                       (claim_w_comorbidity['DSCHRG_CD'].isin(['B','20'])) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT']<=claim_w_comorbidity['DT_3_MONTHS']) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT_FOLLOWING_YEAR']<=claim_w_comorbidity['DT_3_MONTHS']),
                                                       1,0)
    claim_w_comorbidity['oneeighty_day_death_ind'] = np.where(
                                                       (claim_w_comorbidity['DSCHRG_CD'].isin(['B','20'])) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT']<=claim_w_comorbidity['DT_6_MONTHS']) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT_FOLLOWING_YEAR']<=claim_w_comorbidity['DT_6_MONTHS']),
                                                       1,0)
    claim_w_comorbidity['threesixtyfive_day_death_ind'] = np.where(
                                                       (claim_w_comorbidity['DSCHRG_CD'].isin(['B','20'])) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT']<=claim_w_comorbidity['DT_12_MONTHS']) |
                                                       (claim_w_comorbidity['BENE_DEATH_DT_FOLLOWING_YEAR']<=claim_w_comorbidity['DT_12_MONTHS']),
                                                       1,0)
