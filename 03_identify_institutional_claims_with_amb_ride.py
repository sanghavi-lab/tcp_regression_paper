...
for year in years:
    ...
    # Specify columns
    columns_amb = ['BENE_ID','CLM_THRU_DT_x','ind_for_mi_match','HCPCS_CD','PRVDR_STATE_CD','PRVDR_ZIP','HCPCS_1ST_MDFR_CD',
                   'HCPCS_2ND_MDFR_CD','MILES','CLM_FROM_DT'] + ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
    ...
    amb_merge_ip_matched = amb_merge_ip_matched.drop(['BENE_ID','SRVC_BGN_DT', 'SRVC_END_DT', 'ind_for_hos_match', 'CLM_THRU_DT','CLM_FROM_DT']+ ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
                   'BENE_BIRTH_DT', 'SEX_IDENT_CD','BENE_DEATH_DT', 'VALID_DEATH_DT_SW', 'RTI_RACE_CD', 'BENE_DEATH_DT_FOLLOWING_YEAR',
    ...
    amb_merge_op_matched = amb_merge_op_matched.drop(['BENE_ID','SRVC_BGN_DT', 'SRVC_END_DT', 'ind_for_hos_match', 'CLM_THRU_DT','CLM_FROM_DT']+ ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
                   'BENE_BIRTH_DT', 'SEX_IDENT_CD','BENE_DEATH_DT', 'VALID_DEATH_DT_SW', 'RTI_RACE_CD', 'BENE_DEATH_DT_FOLLOWING_YEAR',
                   'VALID_DEATH_DT_SW_FOLLOWING_YEAR','PRNCPAL_DGNS_CD'] + ['ICD_DGNS_CD{}'.format(i) for i in range(1, 13)],axis=1)
    ...
    amb_merge_ip_matched_plusone = amb_merge_ip_matched_plusone.drop(['BENE_ID','SRVC_BGN_DT', 'SRVC_END_DT', 'ind_for_hos_match', 'CLM_THRU_DT','CLM_THRU_DT_PLUSONE','CLM_FROM_DT']+ ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
                   'BENE_BIRTH_DT', 'SEX_IDENT_CD','BENE_DEATH_DT', 'VALID_DEATH_DT_SW', 'RTI_RACE_CD', 'BENE_DEATH_DT_FOLLOWING_YEAR',
                   'VALID_DEATH_DT_SW_FOLLOWING_YEAR','PRNCPAL_DGNS_CD'] + ['ICD_DGNS_CD{}'.format(i) for i in range(1, 13)],axis=1)
    ...
    amb_merge_op_matched_plusone = amb_merge_op_matched_plusone.drop(['BENE_ID','SRVC_BGN_DT', 'SRVC_END_DT', 'ind_for_hos_match', 'CLM_THRU_DT','CLM_THRU_DT_PLUSONE','CLM_FROM_DT']+ ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
                   'BENE_BIRTH_DT', 'SEX_IDENT_CD','BENE_DEATH_DT', 'VALID_DEATH_DT_SW', 'RTI_RACE_CD', 'BENE_DEATH_DT_FOLLOWING_YEAR',
                   'VALID_DEATH_DT_SW_FOLLOWING_YEAR','PRNCPAL_DGNS_CD'] + ['ICD_DGNS_CD{}'.format(i) for i in range(1, 13)],axis=1)
    ...
    amb_merge_ip_matched_plustwo = amb_merge_ip_matched_plustwo.drop(['BENE_ID','SRVC_BGN_DT', 'SRVC_END_DT', 'ind_for_hos_match', 'CLM_THRU_DT','CLM_THRU_DT_PLUSTWO','CLM_FROM_DT']+ ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
                   'BENE_BIRTH_DT', 'SEX_IDENT_CD','BENE_DEATH_DT', 'VALID_DEATH_DT_SW', 'RTI_RACE_CD', 'BENE_DEATH_DT_FOLLOWING_YEAR',
                   'VALID_DEATH_DT_SW_FOLLOWING_YEAR','PRNCPAL_DGNS_CD'] + ['ICD_DGNS_CD{}'.format(i) for i in range(1, 13)],axis=1)
    ...
    # Clean DF
    amb_merge_op_notmatched_plustwo = amb_merge_op_notmatched_plustwo.drop(['SRVC_BGN_DT','SRVC_END_DT','ind_for_hos_match','CLM_THRU_DT_PLUSTWO'],axis=1) # remove only those not needed in sensitivity analysis
    amb_merge_op_matched_plustwo = amb_merge_op_matched_plustwo.drop(['BENE_ID','SRVC_BGN_DT', 'SRVC_END_DT', 'ind_for_hos_match', 'CLM_THRU_DT','CLM_THRU_DT_PLUSTWO','CLM_FROM_DT']+ ['STATE_CODE','COUNTY_CD', 'ZIP_CD',
                   'BENE_BIRTH_DT', 'SEX_IDENT_CD','BENE_DEATH_DT', 'VALID_DEATH_DT_SW', 'RTI_RACE_CD', 'BENE_DEATH_DT_FOLLOWING_YEAR',
                   'VALID_DEATH_DT_SW_FOLLOWING_YEAR','PRNCPAL_DGNS_CD'] + ['ICD_DGNS_CD{}'.format(i) for i in range(1, 13)],axis=1)
